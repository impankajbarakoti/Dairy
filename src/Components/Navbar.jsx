    ...
    <>
      ...
      <nav
        className={`fixed w-full top-0  z-100 flex justify-between  items-center px-6 md:px-12 py-4 transition-all duration-300 ease-in-out ${
          isScrolled
            ? "bg-white shadow-md"
            : "bg-white backdrop:backdrop-blur-2xl"
        }`}
      >
        {/* Logo */}
        <div className="flex items-center">
          <a href="/">
            <img
              src="https://milatte.like-themes.com/wp-content/uploads/2024/11/logo_2x_white.png"
              alt="Logo"
              className="w-18 md:w-16 bg-black md:p-2"
            />
          </a>
        </div>
